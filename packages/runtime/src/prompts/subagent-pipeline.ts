...
export function buildEcoPlanHarnessAdapter(availability: SubagentAvailability): string {
  ...
  return [
    ...
    "2. Required: submit a decision-complete Markdown plan via `ExitPlanMode`.",
    ...
    "- **Submit when ready**: call `ExitPlanMode` once decision-complete per Codex Finalization rule (unanswered preference questions use recommended defaults recorded under Assumptions).",
    "",
