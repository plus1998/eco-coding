...
export function anthropicToResponsesInputTokensBody(req: AnthropicRequest): Record<string, unknown> {
...
export function responsesInputTokensToAnthropicCount(raw: unknown): { input_tokens: number } {
