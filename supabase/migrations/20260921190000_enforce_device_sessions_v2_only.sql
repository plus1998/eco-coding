-- Promote device-session RLS after Desktop/Mobile support and Cloud smoke coverage.
-- The source remains in deferred-migrations for maintenance replay; keep both
-- files semantically identical, including PT409 CAS handling.
