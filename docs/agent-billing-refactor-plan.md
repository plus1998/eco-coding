...
1. 继续拆 run flow 的 SDK driver event execution orchestration，把 usage.recorded/session capture/activity emit/plan capture 的重复循环收口到可测试 helper。
