...
- `bun test`: 通过，`725 pass / 14 skip / 0 fail`
...
1. 将 `processSdkStreamPartialUsage` 中的 stream partial runtime route/pricing artifact 解析和 effects input 构造继续拆成 stream partial billing orchestration。
