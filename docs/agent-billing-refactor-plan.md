...
1. 继续拆 Context Domain：把线程 metrics restore/persist 中的 context snapshot 读写和 SubAgent context hydration 从 `index.ts` 抽成可测试服务。
