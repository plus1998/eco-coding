...
- `bun test`: 通过，`719 pass / 14 skip / 0 fail`
...
1. 将 `processSdkRunBilling` 中的 SDK final model pricing、context usage selection、authoritative observation 和 effects input 构造继续拆成 SDK final run billing resolver。
