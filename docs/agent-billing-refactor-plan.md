...
1. 继续拆 `activeRuns` runtime state，把 run-scoped billing flags、request seq、context role cache 与 AbortController / worktree 状态分层。
