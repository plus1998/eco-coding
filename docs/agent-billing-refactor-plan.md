...
1. 继续拆 Context Domain：把 compaction boundary、mark compact completed/in-flight、post-run compaction 判断从 `index.ts` 抽成可测试 context lifecycle 服务。
