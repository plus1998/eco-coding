...
const PACKAGES = {
  "darwin-arm64": "@anthropic-ai/claude-agent-sdk-darwin-arm64@0.3.168",
  "linux-x64": "@anthropic-ai/claude-agent-sdk-linux-x64@0.3.168",
  "win-x64": "@anthropic-ai/claude-agent-sdk-win32-x64@0.3.168",
};
