...
import { isSkeletonUserPromptItem } from "../shared/conversation-v2-projection-skeleton";
 ...
 * to equal a full rebuild by construction (see legacy-feed-skeleton-timeline-items.ts) — they only
