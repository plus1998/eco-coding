...
function ProjectionActivityLogView({
  ...
  const subagentAgents = useMemo(
    () => projection.agents.filter((agent) => agent.kind === "subagent"),
    [projection.agents],
  );
...
function projectionItemToDetailBlock(
  item: ThreadRunProjectionTimelineItem,
...
function isProjectionRequestActive(
...
function resolveProjectionAgentStatusText(agent: ThreadRunProjectionAgent): string | undefined {
