/**
 * Shared multi-step scenario prompt for Codex / PI / Claude SDK recording.
 */
export function buildScenarioPrompt(marker) {
  return [
    `You are running an Eco conversation-round scenario smoke. Marker=${marker}.`,
